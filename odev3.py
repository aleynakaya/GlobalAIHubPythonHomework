...
kelimeler = ["araba" , "lunapark" , "otobüs" , "kemençe" , "zeytin" , "küpe" , "kalorifer" , "deniz" , "lamba" , "kereviz"]
kelime = random.choice(kelimeler) 
tahminSayisi = 5
isim = input("İsminizi Giriniz : ")
print("{},Adam Asmaca Oyununa Hoşgeldin".format(isim))
print("Toplam 5 Can Hakkınız Bulunmaktadır.")
print("Tahmin Girişlerinizi Küçük Harf Olarak Yapınız!")
harfler = [] 
x = len(kelime)
z = list('_' * x)
print(' '.join(z), end='\n')
